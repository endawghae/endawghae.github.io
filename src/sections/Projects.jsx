...
const projects = [
  {
    ...
    link: "https://gdacdavis.itch.io/ylp",
  },
  {
    title: "Sherby",
    description: "A passion project with a small indie team to create a retro-style 2d platformer",
    image: "/projects/project2.png",
    animated: "/projects/project2.webp",
    tags: ["Unity", "C#", "WebGL", "Software Development"],
    link: "https://endawghae.itch.io/sherby-test",
  },
  {
    title: "YTPL Shuffler",
    description: "A simple GUI that utilizes VLC and YT-DLP to play and shuffle youtube playlists with helpful features such as caching for faster music changes and session saving to pick up right where you left off",
    image: "/projects/project3preview.png",
    animated: "/projects/project3.png",
    tags: ["Python", "Multithreading", "Software Development", "CI/CD"],
    link: "https://github.com/endawghae/youtube-playlist-shuffler/",
  },
];
      ...
      <div className="container mx-auto px-6 relative z-10">
        ...
        <div className="text-center mx-auto max-w-3xl mb-16">
          ...
          <p className="text-muted-foreground animate-fade-in animation-delay-200">
            Some of my recently completed works
          </p>
        </div>
